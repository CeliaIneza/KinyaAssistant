...
INTENTS = {
    "greeting": {
        "patterns": ["muraho", "amahoro", "mwiriwe", "wiriweho"],
        "responses": [
            "Muraho neza!",
            "Mwiriwe! Ufite ikihe kibazo uyu munsi?"
        ]
    },
    "ask_news": {
        ...
        "responses": [
            ...
            "Umunsi wagenze neza. Wowe bimeze bite?",
            "Icyumweru cyagenze neza rwose, wowe ho?",
            "Mugitondo wagenze neza cyane! Wowe uko byagenze?",
        ]
    },
        "gratitude": {
        "patterns": ["urakoze cyane", "murakoze", "ndashimira", "turabashimira"],
        "responses": [
    ...
    "default": {
        "patterns": [],
        "responses": [
            "Mbabarira, sinashoboye kumva neza. Ongera usubiremo.",
            "Sinabyumvise neza, ushobora gusubiramo ikibazo cyawe?",
        ]
    }
}
...
QA = {
    "ni ibihe biryo abana bato bakunda kurya": 
        "Abana bato bakunda kurya ifirti n'inyama",
    "u rwanda ruzwiho ibiki": 
        "u rwanda ruzwiho kuba rufite ingagi ndetse n'imisozi miremire cyane",
